...
Donate link: http://eventprime.net/
...
EventPrime also offers a wide selection of additional [free and premium extensions](https://eventprime.net/extensions/) for all your requirements.
...
EventPrime is a WordPress Events Calendar plugin that supports free event bookings, paid event bookings, single day events, multi-day events, event performers, event sites, event gallery, event registration, event calendar widget and a lot more. Check out our [Starter Guide](https://eventprime.net/starter-guide/) to get up and running with this awesome event manager tool.

> If you want more of our new WordPress events plugin, do check out its [Extensions](http://eventprime.net/extensions/). We have added Live Seating, Event Analytics, Event Sponsors, Stripe Payments, Offline Payments, Recurring Events and a lot more planned for the future!
...
[Download Events Import Export Extension for EventPrime - Modern Events Calendar](https://eventprime.net/extensions/events-import-export/)
...
[Download EventPrime MailPoet Integration for EventPrime - Modern Events Calendar](https://eventprime.net/eventprime-mailpoet/)
...
[Download EventPrime WooCommerce Integration for EventPrime - Modern Events Calendar](https://eventprime.net/eventprime-woocommerce-integration/)

= Invoices Free =

Create customized invoicing template with your own branding, and attach automatically to booking confirmation emails.

[Download EventPrime Invoices Extension for EventPrime - Modern Events Calendar](https://eventprime.net/eventprime-invoices/)
...
[Download EventPrime Zoom Integration For EventPrime - Modern Events Calendar](https://eventprime.net/eventprime-zoom-integration/)
...
[Download Live Seating](https://eventprime.net/extensions/live-seating/)
...
[Download Event Sponsors](https://eventprime.net/extensions/event-sponsors/)
...
[Download Offline Payments](https://eventprime.net/extensions/offline-payments/)
...
[Download Stripe Payments](https://eventprime.net/extensions/stripe-payments/)
...
[Download Coupon Codes](https://eventprime.net/extensions/coupon-codes/)
...
[Download Guest Bookings](https://eventprime.net/extensions/guest-bookings/)
...
[Download Admin Attendee Bookings](https://eventprime.net/extensions/admin-attendee-bookings/)
...
Check out our [Starter Guide](http://eventprime.net/starter-guide/) to get up and running with EventPrime.

= I found a bug in EventPrime. How should I report it to you? =

That's easy. Just write to us at our [Contact page](http://eventprime.net/contact/) and our support team will get in touch with you in a matter of minutes.

= I like EventPrime, but it doesn't have some of the features I really require. How can I get them? =

We are always happy to hear your particular needs and requirements. Similar to reporting a bug, just write to us at our [Contact page](http://eventprime.net/contact/). Our support team will contact you right away.


== Screenshots ==

1. Event Manager Backend Page
2. Event Type Manager Backend Page
3. Event Site Manager Backend Page
4. Performer Manager Backend Page
5. Add New Event Backend Form
6. Event Dashboard Configuration Options
7. Event Settings Backend Form
8. Global Settings Configuration Options
9. Shortcodes Backend Page
10. All Events Card View on Frontend
11. All Events Calendar View on Frontend
12. Single Event View on Frontend
