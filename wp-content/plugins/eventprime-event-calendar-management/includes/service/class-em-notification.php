...
class EventM_Notification_Service {
    ...
    {  
        ...
        $bookingIdDate = $booking->id . ' - ' .date_i18n(get_option('date_format').' '.get_option('time_format'), $event->start_date);
        self::configure_mail();
        ...
        /* send Mail to Admin */   
        $mail_body = file_get_contents(EM_BASE_URL.'includes/mail/admin_confirm.html');
