    ...
    <div class="ep-sc-wrap dbfl">
        ...
        <div class="ep-sc-blocks dbfl">
            <div class="ep-sc-block ep-all-event-block difl">
                ...
                <div class="ep-sc-block-row dbfl"><span class="ep-code"><a target="_blank" href="<?php echo admin_url('post.php?post='.$options->events_page.'&action=edit'); ?>">[em_events view="x" types="1,2,&#133;" sites="1,2,&#133;" show="5" upcoming="0 or 1" recurring="0 or 1" disable_filter="0 or 1" filter_elements="keyword,type,date,site" individual_events="yesterday or today or tomorrow or this month"]</a></span></div>
        ...
        <div class="ep-sc-blocks dbfl">
            <div class="ep-sc-block difl">
                ...
                <div class="ep-sc-block-row dbfl"><span class="ep-code"><a target="_blank" href="<?php echo admin_url('post.php?post='.$options->venues_page.'&action=edit'); ?>">[em_sites]</a></span></div>
                <div class="ep-sc-block-row dbfl"> <img class="ep-scimg" src="<?php echo EM_BASE_URL . 'includes/admin/template/images/em-all-Venues.jpg' ?>">
                    <div class="ep-sc-block-row dbfl ep-scdesc">Displays the all Event Sites panel on the frontend where users can view the list of Event Sites at which events can take place.</div>
                </div>
            </div>
            <div class="ep-sc-block difl">
        ...
        <div class="ep-sc-blocks dbfl">
            ...
            <div class="ep-sc-block difl">
                ...
                <div class="ep-sc-block-row dbfl"><span class="ep-code">[em_event_site id="x" upcoming="0 or 1"]</span></div>
                <div class="ep-sc-block-row dbfl"> <img class="ep-scimg" src="<?php echo EM_BASE_URL . 'includes/admin/template/images/em-single-vanue.jpg' ?>">
                    <div class="ep-sc-block-row dbfl ep-scdesc">Displays all details of a single Event Site. Replace x with the Event Site ID. 'upcoming' attribute will be use to hide or show upcoming events.</div>
                </div>
            </div>
        </div>
