            ...
            <div class="ep-setting-wrap" ng-show="enabledAnyGlobalService">
                ...
                <div ng-show="showPerformerSettings">
                    ...
                    <div class="emrow" ng-show="data.options.performer_display_view == 'box'">
                        <div class="emfield"><?php _e('Box Color', 'eventprime-event-calendar-management'); ?></div>
                        <div class="eminput">
                            <ul>
                        ...
                        <div class="emnote"><i class="fa fa-info-circle" aria-hidden="true"></i>
                            <?php _e('Select the box color.', 'eventprime-event-calendar-management'); ?>
                        </div>
                    </div>
                    <div class="emrow">
                    ...
                    <div class="emrow">
                        ...
                        <div class="emfield_error"></div>
                        <div class="emnote"><i class="fa fa-info-circle" aria-hidden="true"></i>
                            <?php _e('Select the display style of related events.', 'eventprime-event-calendar-management'); ?>
                        </div>
                    </div>
                    <div class="emrow">
