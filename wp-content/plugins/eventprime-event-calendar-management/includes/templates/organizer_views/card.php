                ...
                <div class="ep-box-card-item">
                    <div class="ep-box-card-thumb" >
                        <?php if ( ! empty( $organizer->image_id ) ) { ?>
                            <a href="<?php echo add_query_arg( "organizer", $organizer->id, $organizers_page_url ); ?>" class="ep-img-link"><img src="<?php echo wp_get_attachment_image_src( $organizer->image_id, 'large' )[0] ; ?>" alt="<?php _e( 'Event Organizer Image', 'eventprime-event-calendar-management' ); ?>"> </a>
                        <?php }else{ ?>
                            <a href="<?php echo add_query_arg( "organizer", $organizer->id, $organizers_page_url ); ?>" class="ep-img-link"><img src="<?php echo esc_url( plugins_url( '../images/dummy-organizer.png', __FILE__ ) ) ?>" alt="<?php _e('Dummy Image','eventprime-event-calendar-management'); ?>"></a> 
                        <?php } ?>
                    ...
                    <div class="ep-box-card-content">
                        <div class="ep-box-title ep-box-card-title">
                            <a href = "<?php echo add_query_arg( "organizer",$organizer->id, $organizers_page_url ); ?>"><?php echo $organizer->name; ?></a> 
                        </div>
