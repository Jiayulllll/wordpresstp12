                        ...
                        <div class="ep-box-box-item">
                            <div class="ep-box-box-thumb">
                                <?php if ( ! empty( $organizer->image_id ) ){ ?>
                                    <a href="<?php echo add_query_arg( "organizer", $organizer->id, $organizers_page_url ); ?>" class="img-fluid"><img src="<?php echo wp_get_attachment_image_src( $organizer->image_id, 'large' )[0]; ?>" alt="<?php _e('Event Organizer Image', 'eventprime-event-calendar-management'); ?>"></a>
                                <?php }else{ ?>
