    ...
    <div class="emagic">
        <div ng-hide="show_cart">
            ...
            <div class="kf-standing-type-popup kf-standing-type-popup-wrap" ng-show="event.venue.type == 'standings' || event.venue.type == ''">
                <div id="kf-seat-table-parent" class="em_block dbfl kf_config_pop " >
                    ...
                    <div class="ep-event-pricing-info-wrap dbfl" ng-if="event.price_option_data.length > 1 && (event.venue.type == 'standings' || event.venue.type == '')">
        ...
        <div id="booking_summary" class="em-before-payment dbfl" ng-show="show_cart && orders.length > 0"> 
                    ...
                    <div class="ep-billing-details-wrap">
                        <div class="ep-billing-coupons">
                            ...
                            <!--<div class="em_discount em_align_right dbfl" ng-show="discount > 0">
                                <span class="em_subtotal difl"><?php _e("Discount", 'eventprime-event-calendar-management'); ?></span> -&nbsp;
                                <span>{{discount | currencyPosition: event.currency_position : currency_symbol}}</span>
                            </div>-->
                        </div>
            ...
            <div class="dbfl em_block">     
                <a href="<?php echo get_permalink($event_id); ?>"><?php _e("Go to Event", 'eventprime-event-calendar-management'); ?></a>
            </div>
        ...
        <div id="kf-reconfirm-popup" class="dbfl" ng-show="!bookable" ng-cloak>
            <div class="dbfl em_block kf-reconfirm-popup-content">
                <p><?php _e('Sorry, the time window for checkout has expired. Selected seats have been released for bookings. You can click here to go back to the Event page and try booking again.', 'eventprime-event-calendar-management'); ?></p>
                <a href="<?php echo get_permalink($event_id); ?>"><?php _e('OK', 'eventprime-event-calendar-management'); ?></a>
            </div>
        </div>
