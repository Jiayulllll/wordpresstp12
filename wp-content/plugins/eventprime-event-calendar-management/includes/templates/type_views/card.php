                ...
                <div class="ep-box-card-item">
                    <div class="ep-box-card-thumb" >
                        <?php if ( ! empty( $type->image_id ) ) { ?>
                            <a href="<?php echo add_query_arg( "type", $type->id, $types_page_url ); ?>" class="ep-img-link"><img src="<?php echo wp_get_attachment_image_src( $type->image_id, 'large' )[0] ; ?>" alt="<?php _e( 'Event Type Image', 'eventprime-event-calendar-management' ); ?>"> </a>
                        <?php }else{ ?>
                            <a href="<?php echo add_query_arg( "type", $type->id, $types_page_url ); ?>" class="ep-img-link"><img src="<?php echo esc_url( plugins_url( '../images/dummy_image.png', __FILE__ ) ) ?>" alt="<?php _e('Dummy Image','eventprime-event-calendar-management'); ?>"></a> 
                        <?php } ?>
                    </div>
                    <div class="ep-box-card-content">
                        <div class="ep-box-title ep-box-card-title">
                            <a href = "<?php echo add_query_arg( "type",$type->id, $types_page_url ); ?>">
                                <?php echo $type->name; ?>
                            </a> 
                        </div>
