                        ...
                        <div class="ep-box-box-item">
                            <div class="ep-box-box-thumb">
                                <?php if ( ! empty( $type->image_id ) ){ ?>
                                    <a href="<?php echo add_query_arg( "type", $type->id, $types_page_url ); ?>" class="img-fluid"><img src="<?php echo wp_get_attachment_image_src( $type->image_id, 'large' )[0]; ?>" alt="<?php _e('Event Type Image', 'eventprime-event-calendar-management'); ?>"></a>
                                <?php }else{ ?>
                            ...
                            <div class="ep-performer-content">
                                <div class="ep-box-title ep-box-box-title"><a href="<?php echo add_query_arg( "type", $type->id, $types_page_url ); ?>"><?php echo $type->name; ?></a> </div>
