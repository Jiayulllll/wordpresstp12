        ...
        <div class="ep-box-list-wrap">
            <div class="ep-box-row">
                ...
                <?php if (!empty($type->image_id)){ ?>
                        <a href="<?php echo add_query_arg("type", $type->id, $types_page_url); ?>" ><img src="<?php if (isset($type->image_id)) echo wp_get_attachment_image_src($type->image_id, 'large')[0]; else echo esc_url(EM_BASE_FRONT_IMG_URL.'dummy_image.png'); ?>" alt="<?php _e('Event Type Image', 'eventprime-event-calendar-management'); ?>"> </a>
                <?php }else{ ?>
                    <a href="<?php echo add_query_arg("type", $type->id, $types_page_url); ?>" > <img src="<?php echo esc_url(plugins_url('../images/dummy_image.png', __FILE__)) ?>" alt="<?php _e('Dummy Image','eventprime-event-calendar-management'); ?>"> </a>
                <?php } ?>  
            </div>
            <div class="ep-box-col-6 ep-list-box-table">
                <div class="ep-box-list-items">
                    <div class="ep-box-title ep-box-list-title">
                        <a class="ep-color-hover" data-type-id="<?php echo $type->id;?>" href="<?php echo add_query_arg("type",$type->id, $types_page_url); ?>" target="_self" rel="noopener">
                            <?php echo $type->name; ?>
                        </a>
                    </div>
